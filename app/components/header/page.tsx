...
const Header = () => {
  ...
  const scrollToExperiences = () => {
    ...
    console.log(experiencesSection);
    if (experiencesSection) {
      const offset = 0; // Adjust this value as needed
      const topPos =
        experiencesSection.getBoundingClientRect().top + window.scrollY;
  ...
  return (
    <div className="sticky top-0 z-10">
      <div className="bg-jbgGrey">
        <div className="container h-[3rem] flex items-center justify-between font-bold max-[362]:text-[2rem]">
          <div className="">
            <div className="pl-[1rem] inline-block hover:text-jcream">
              <button onClick={scrollToTop}>HOME</button>
            </div>
            <div className=" pl-[1rem] inline-block hover:text-jcream">
              <button onClick={scrollToExperiences}>EXPERIENCE</button>
            </div>
            <div className="pl-[1rem] inline-block hover:text-jcream">
          ...
          <div className="mx-[1%]">
            <div className="inline-block hover:text-jred mr-2 hover:scale-110">
              <Link
                target="_Blank"
            ...
            <div className="inline-block hover:text-jred hover:scale-110 mr-2">
              <Link
                target="_Blank"
